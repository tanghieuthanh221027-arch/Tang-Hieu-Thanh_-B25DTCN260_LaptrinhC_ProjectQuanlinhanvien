...
void addEmployee() {
    ...
    if (strlen(e.empId) == 0 || findEmpbyID(e.empId) != -1) {
        printf("Ma nhan vien rong hoac da ton tai!\n");
        return;
    }
    ...
    printf("Them moi nhan vien thanh cong!\n");
}
...
void addSampleList(){
	Employee e1 = {"HG001" , "Vu Hoang Lan Anh" , "Quan li" , 2000 , 5};
